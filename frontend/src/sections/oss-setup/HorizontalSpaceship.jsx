  ...
  return (
    ...
    >
      ...
      <Box
        ...
        sx={{ position: "absolute", left: 0, right: 0, top: "50%", width: "100%", height: 4 }}
      >
        <line
      ...
      >
        ...
        >
          {/* Thrust trail */}
          <g style={{ animation: `${flow} 0.6s linear infinite` }} strokeWidth="1.3" strokeOpacity="0.5" strokeDasharray="3 4">

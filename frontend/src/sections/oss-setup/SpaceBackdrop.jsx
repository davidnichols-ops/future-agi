...
// Decorative, non-interactive space scene behind the OSS setup steps. Pure CSS
// (twinkling starfield + drifting shooting stars + a floating rocket) so it adds
// life without any runtime cost or blocking the content above it.
...
export default function SpaceBackdrop() {
  return (
    ...
    >
      ...
      {/* Shooting stars — rocket now lives inline below the wordmark */}
      {[
